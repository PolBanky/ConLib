...
namespace WinLib
{
    public static class Trig
    {
        ...
        {
            return Math.Pow(d_ex, 3) * Trig.PiDiv16 * (1 - Math.Pow((d_in / d_ex), 4));
        }   // end of - PolarWCircleRing()


        public static double PolarWRectangle(double b_ex, double h_ex)
        {
            return Trig.alfa(h_ex / b_ex) * h_ex * Math.Pow(b_ex, 2);
